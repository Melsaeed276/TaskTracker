<!-- GENERATED from agents/camera-auditor.md by scripts/build-inlined-auditors.ts — do not edit. -->

# Camera & Capture Auditor

**Claude Code** — launch the `camera-auditor` agent, or run `/axiom:audit camera`. It runs this procedure in an isolated context with its own model tier.
